...
var table = ee.FeatureCollection("projects/ee-chancy/assets/Solar_Panel_Training_Data");
...
var sentinel2_with_indices = sentinel2.map(addIndices);
...
var classifier = ee.Classifier.smileRandomForest(500).train({
  features: training,
  classProperty: 'class',
  inputProperties: ['B2', 'B3', 'B4', 'B11', 'NDVI', 'NDBI', 'NDWI', 'VH', 'VH_savg']
});
...
var accuracy = confusionMatrix.accuracy();  // Overall accuracy
var producersAccuracy = confusionMatrix.producersAccuracy();  // Producer's accuracy
var usersAccuracy = confusionMatrix.consumersAccuracy();  // User's accuracy
